...
namespace Resources
{
    ...
    public class ProcessResources
    {
        ...
        [
            McpServerResource(UriTemplate = "process://current", Title = "Current Process"),
            Description("Get information about the currently attached Cheat Engine process")
        ]
        public static string GetCurrentProcess()
        {
            return CeLuaGate.Run<string>(() =>
            {
                try
                {
        ...
        [
            McpServerResource(UriTemplate = "process://threads", Title = "Thread List"),
